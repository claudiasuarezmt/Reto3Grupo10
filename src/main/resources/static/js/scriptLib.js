...
function habilitaDatosLib(nuTipo) {
    ...
    if (nuTipo === 2) {
        campos += "<label width: 180px;>Capacidad: </label><input type=text id=capacityLib class=input><br>";
    } else {
        campos += "<label width: 180px;>Capacidad: </label><input type=text id=capacityLib disabled class=input><br>";
    }
    if (nuTipo == 2) {
        campos += "<label width: 180px;>Descripcion: </label><input type=text id=descriptionLib class=input><br>";
    } else {
        campos += "<label width: 180px;>Descripcion: </label><input type=text id=DescriptionLib disabled class=input><br>";
